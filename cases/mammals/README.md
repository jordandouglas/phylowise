...
This script will by default run just 10 iterations on 10 random trees from the posterior, applying PPC between all combinations of variables (nS, nN, mass, longetivity, age of sexual maturity, and fecundity). This should take a few minutes to complete. In the main article, we performed 1000 iterations.
